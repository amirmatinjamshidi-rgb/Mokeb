...
{
    public class ChangingCaravansPrincipalCommandValidator : AbstractValidator<ChangingCaravansPrincipalCommand>
    {
        public ChangingCaravansPrincipalCommandValidator()
        {
            RuleFor(x => x.Name)
                .NotEmpty()
